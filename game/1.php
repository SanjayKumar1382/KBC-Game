...
<html>	
	<head>
		...
		<?php
			...
			if(!isset($_SESSION['win']) && empty($_SESSION['win']))
				$_SESSION['win']=0;
			echo $_SESSION['win'];
			...
			$no = mt_rand(1,10);
			$sql = "select * from ques1 where no = "."$no" ;
	...
	<button type="button" class="exit" onclick="exit()">Exit</button>
		...
		<div id="time">30</div>
		<div class="container">
			<div class="question">Q. <?php echo $no." ".$ques; ?> </div>
		...
		<div class="rscontainer">
			...
			<p id="5">Rs. 80,000</p>
			<p id="4">Rs. 40,000</p>
			<p id="3" style="color:red;">Rs. 20,000</p>
			<p id="2" style="color:red;">Rs. 10,000</p>
			<p id="1" style="color:red;background-color:green;">Rs. 5,000</p>
		</div>
